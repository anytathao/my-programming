...
# Main execution
def main():
    read_oscillatory_wave_data("oscillatory_2540830.csv")
    read_standing_wave_data("standing_2540830.csv")

    create_personalized_oscillatory_file(
        "oscillatory_2540830.csv",
        "oscillatory_personalized_2540830.csv"
    )

    create_personalized_standing_file(
        "standing_2540830.csv",
        "standing_personalized_2540830.csv"
    )
